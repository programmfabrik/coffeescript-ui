class Icon extends CUI.Element
	...
	icon_map:
		...
		legal: "fa-legal"
		cloud: "fa-cloud"
		left: if CUI.__ng__ then "fa-chevron-left" else "fa-angle-left"
		right: if CUI.__ng__ then "fa-chevron-right" else "fa-angle-right"
		...
		west: if CUI.__ng__ then "fa-angle-left" else "fa-long-arrow-left"
		east: if CUI.__ng__ then "fa-angle-right" else "fa-long-arrow-right"
		south: if CUI.__ng__ then "fa-angle-down" else "fa-long-arrow-down"
		north: if CUI.__ng__ then "fa-angle-up" else "fa-long-arrow-up"
		up: "fa-caret-up"
		down: "fa-caret-down"
		camera: "fa-camera"
