...
class CUI.Tooltip extends CUI.LayerPane
	constructor: (@opts = {}) ->
		...
		if @_on_hover
			...
			CUI.DOM.addClass(@__element.DOM, "cui-dom-element-has-tooltip cui-dom-element-has-tooltip-on-hover")
			return

		if @_on_click
			CUI.DOM.addClass(@__element.DOM, "cui-dom-element-has-tooltip cui-dom-element-has-tooltip-on-click")
