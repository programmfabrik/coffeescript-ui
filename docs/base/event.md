...
# Event.require(event, debug_output)
...
**debug_output** is used to show inside the assert for identification if the CUI.Event could not be created.

**options** get default options from registered Events.
